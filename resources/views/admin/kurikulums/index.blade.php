                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                                    ...
                                    <form method="post" action="/kurikulum/import_excel" enctype="multipart/form-data">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src={{ asset('images/ContohImportKurikulum.png') }}
                            ...
                            <a href="/kurikulum/delete_all" class="btn btn-sm btn-danger"
                                ...
                                <tbody>
                                    @foreach ($kurikulum as $no => $mata_kuliah)
                                        <tr>
                                            ...
                                            <td><a href="{{ asset($mata_kuliah->document) }}"
                                                    target="_blank">{{ $mata_kuliah->document }}</a></td>
                                            <td>
